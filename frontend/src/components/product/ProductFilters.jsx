      ...
      <div>
        ...
        <div className="space-y-1">
          <label className="flex items-center gap-2.5 text-sm cursor-pointer py-1 group">
            <span
              className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${!filters.category ? "border-zinc-900 bg-zinc-900" : "border-zinc-300 group-hover:border-zinc-400"}`}
            >
              {!filters.category && (
          ...
          {categories?.map((c) => (
            <label
              key={c._id}
              className="flex items-center gap-2.5 text-sm cursor-pointer py-1 group"
            >
              <span
                className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${filters.category === c._id ? "border-zinc-900 bg-zinc-900" : "border-zinc-300 group-hover:border-zinc-400"}`}
              >
      ...
      <div>
        ...
        <div className="space-y-1">
          {[
            ...
            >
              <span
                className={`w-4 h-4 rounded-full border-2 flex items-center justify-center shrink-0 transition-colors ${filters.availability === val ? "border-zinc-900 bg-zinc-900" : "border-zinc-300 group-hover:border-zinc-400"}`}
              >
